...
<body>
    <nav class="navbar">
        ...
        <ul class="navbar-nav">
            ...
            <li><a href="{{ route('chats') }}" class="nav-link {{ request()->routeIs('chats') ? 'active' : '' }}"><svg viewBox="0 0 24 24"><path d="M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm0 14H6l-2 2V4h16v12z"/></svg>Messages</a></li>
    ...
    <nav class="mobile-nav">
        <ul class="mobile-nav-links">
            <li><a href="{{ route('home') }}" class="mobile-nav-link {{ request()->routeIs('home') ? 'active' : '' }}"><svg viewBox="0 0 24 24"><path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/></svg>Decouvrir</a></li>
            <li><a href="{{ route('chats') }}" class="mobile-nav-link {{ request()->routeIs('chats') ? 'active' : '' }}"><svg viewBox="0 0 24 24"><path d="M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm0 14H6l-2 2V4h16v12z"/></svg>Messages</a></li>
            ...
            <li><a href="{{ route('interets.index') }}" class="mobile-nav-link {{ request()->routeIs('interets.*') ? 'active' : '' }}"><svg viewBox="0 0 24 24"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-9 14H7v-7h3v7zm7 0h-3V7h3v10z"/></svg>Interets</a></li>
        </ul>
    </nav>
    @yield('scripts')
</body>
